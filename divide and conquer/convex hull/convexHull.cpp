...
//end points of L are p1 and p2, side can have value 1 or -1
...
void quickHull(iPair a[], int n, iPair p1, iPair p2, int side)
{
    ...
    //find point with max distance from L and also on the specified
    //side of L
    for (int i = 0; i < n; i++)
    {
    ...
    //recur for the two parts divided by the a[ind]
...
void printHull(iPair a[], int n)
{
    ...
    //find point with min and max x coordinate
    int min_x = 0, max_x = 0;
    for (int i = 1; i < n; i++)
    {
    ...
    //recursively find convex hull points on one side of line
    //joining a[min_x] and a[max_x]
    quickHull(a, n, a[min_x], a[max_x], 1);
    //recursively find convex hull points on other side of line
    //joining a[min_x] and a[max_x]
    quickHull(a, n, a[min_x], a[max_x], -1);
